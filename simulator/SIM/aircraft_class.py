...
class aircraft:
    ...
    def decision_making(self,ATC_list,separation,v_max,dt): 
        brake = self.radar_check(separation)        
#        brake = self.collision_avoidence(ATC_list,separation) # check if there are any aircraft within seperation minimum (aircraft should brake if True)
    ...
    def collision_avoidence(self,ATC_list,separation):
    ...
    # checks all planes the radar has detected, which type of conflict would occur when within seperation
